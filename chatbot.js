var faqData = [
    {
        ...
        q: "본인을 한마디로 정의한다면?",
        a: "'성과가 날 때까지 절대 멈추지 않는 사람'이에요. 열심히 한다는 말은 누구나 하지만, 저는 숫자로 증명하거든요. 하나투어 Q1 목표 103% 달성, Q2 성장률 +282%, 인사동 일 매출 73% 상승까지 — 어떤 환경에서도 결과를 만들어낸 게 제 트랙레코드예요. 결과에 집착하는 사람이 필요하다면, 그게 저입니다!"
    },
    {
        keywords: ["강점", "장점", "잘하는"],
        q: "가장 큰 강점은 무엇인가요?",
        a: "문제를 발견하면 그냥 넘어가질 못해요. 하나투어에서 수기 업무가 영업 시간을 갉아먹고 있을 때, 불평 대신 AI 대시보드를 직접 만들어버렸거든요. 개발자가 아닌 영업사원이 Claude Code로 Next.js 앱을 배포한 거예요. 판만 깔아주면 스스로 도구를 만들고 성과를 가져오는 사람 — 저 같은 사람이 팀에 한 명만 있어도 확실히 다르거든요 ^ㅁ^"
    },
    {
    ...
    },
    {
        ...
        q: "AI를 어떻게 업무에 활용하나요?",
        a: "저한테 AI는 '개발 지식'이 아니라 '실행 속도'예요. 남들이 기획안 만드는 시간에 저는 이미 동작하는 걸 만들어버려요. 실제로 영업사원 신분으로 인센티브 정산 시스템을 기획·개발·배포까지 단독으로 해냈거든요. AI를 도구로 쓸 줄 아는 영업사원은 그냥 영업사원 한 명이 아니에요. 그게 저의 차별점입니다!"
    },
    {
