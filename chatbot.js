var faqData = [
    ...
    {
        keywords: ["마이리얼트립", "지원", "왜", "인바운드"],
        q: "왜 마이리얼트립 인바운드인가요?",
        a: "제가 가장 사랑하는 여행과 한국을 세계에 알리는 일이니까요! 폭발적으로 성장하는 인바운드 시장에서 마이리얼트립과 함께 압도적 1등을 만들고 싶어 뛰어들었습니다."
    },
    {
        keywords: ["강점", "장점", "잘하는"],
        q: "가장 큰 강점은 무엇인가요?",
    ...
    },
    {
        ...
        a: "AI는 제게 개발 지식이 아니라 실행의 속도입니다. 남들이 기획안만 쓰고 있을 때, 저는 AI와 협업해 프로토타입을 만들고 바로 시장 반응을 확인합니다. 이 기민함이 마이리얼트립의 인바운드 사업을 남들보다 2배, 3배 빠르게 성장시킬 무기라고 생각합니다."
    },
    {
        keywords: ["마지막", "한마디", "각오", "포부"],
        q: "마지막으로 하고 싶은 말은?",
        a: "저는 마이리얼트립에 제 역량을 쏟아부어 함께 이기러 갑니다. 저 왕유빈이 그 속도를 더하겠습니다. 잘 부탁드립니다 ^ㅁ^"
    }
];
